...
/**
 * Created by 解晓辉  on 2016/12/1 16:52 *
 * QQ  ：811733738
 * 作用:
 */
...
public class TypeBean {
    ...
    public TypeBean(String tag, boolean isChecked) {
        this.tag = tag;
    ...
    public static class DataBean {
        ...
        public static class TagListBean {
            ...
            public TagListBean setTagName(String tagName) {
                this.tagName = tagName;
                return TagListBean.this;
            }
            ...
            public TagListBean setTagId(int tagId) {
                this.tagId = tagId;
                return TagListBean.this;
            }
        }
