...
public class Cinema {
    ...
    public static class DataBean {
        ...
        private ArrayList<List> regions = new ArrayList<>();

        public ArrayList<List> getRegions() {
            return regions;
        }

        public void setRegions() {
            regions.add(chaoyang);
            regions.add(haidian);
            regions.add(daxing);
            regions.add(dongcheng);
            regions.add(fengtai);
            regions.add(xicheng);
            regions.add(tongzhou);
            regions.add(changping);
            regions.add(fangshan);
            regions.add(shunyi);
            regions.add(mentougou);
            regions.add(shijingshan);
            regions.add(huairou);
            regions.add(pinggu);
            regions.add(miyun);
            regions.add(yanqing);
