...
/**
 * Created by 解晓辉  on 2016/12/2 18:36 *
 * QQ  ：811733738
 * 作用:
 */

public class ExptctedAdapter extends CommonAdapter<ExpectedBean.DataBean.MoviesBean> {
    private boolean xihuan = false;
    public ExptctedAdapter(Context context, int layoutId, List<ExpectedBean.DataBean.MoviesBean> datas) {
        super(context, layoutId, datas);
    }

    @Override
    protected void convert(ViewHolder holder, ExpectedBean.DataBean.MoviesBean moviesBean, int position) {
        ...
        holder
                ...
                .setText(R.id.tv_wish,"总想看"+moviesBean.getWish()+"想看")
