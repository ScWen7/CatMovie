package com.atguigu.cateyesmovie.baseRecyclerAdapter.wrapper;
...
public class WrapAdapter<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemCount() {
        int itemCount = mHeaderViewInfos.size() + mRealAdapter.getItemCount() + mFooterViewInfos.size();
    ...
    public int getItemViewType(int position) {
        ...
        if (isHeaderPosition(position)) {
            type= mHeaderViewInfos.get(position).viewType;

        } else if (isFooterPosition(position)) {
            type= mFooterViewInfos.get(position - mHeaderViewInfos.size()
                    - mRealAdapter.getItemCount()).viewType;

        } else {
            type= mRealAdapter.getItemViewType(position - mHeaderViewInfos.size());
        }
